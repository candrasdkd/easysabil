  ...
  const fetchSensus = async () => {
    try {
      ...
      if (sensusResponse.data) {
        const counts = {
          totalKK,
          totalUsers: sensusResponse.data.length - sensusResponse.data.filter(item => item.is_educate === true).length,
          totalAdult: sensusResponse.data.filter(item => item.level === 'Dewasa' && item.is_educate === false).length,
          totalAdultWomen: sensusResponse.data.filter(item => item.level === 'Dewasa' && item.gender === 'Perempuan' && item.is_educate === false).length,
          totalAdultMen: sensusResponse.data.filter(item => item.level === 'Dewasa' && item.gender === 'Laki - Laki' && item.is_educate === false).length,
          totalPraNikah: sensusResponse.data.filter(item => item.level === 'Pra Nikah' && item.is_educate === false).length,
          totalPraNikahWomen: sensusResponse.data.filter(item => item.level === 'Pra Nikah' && item.gender === 'Perempuan' && item.is_educate === false).length,
          totalPraNikahMen: sensusResponse.data.filter(item => item.level === 'Pra Nikah' && item.gender === 'Laki - Laki' && item.is_educate === false).length,
          totalRemaja: sensusResponse.data.filter(item => item.level === 'Remaja' && item.is_educate === false).length,
          totalRemajaWomen: sensusResponse.data.filter(item => item.level === 'Remaja' && item.gender === 'Perempuan' && item.is_educate === false).length,
          totalRemajaMen: sensusResponse.data.filter(item => item.level === 'Remaja' && item.gender === 'Laki - Laki' && item.is_educate === false).length,
          totalPraRemaja: sensusResponse.data.filter(item => item.level === 'Pra Remaja' && item.is_educate === false).length,
          totalPraRemajaWomen: sensusResponse.data.filter(item => item.level === 'Pra Remaja' && item.gender === 'Perempuan' && item.is_educate === false).length,
          totalPraRemajaMen: sensusResponse.data.filter(item => item.level === 'Pra Remaja' && item.gender === 'Laki - Laki' && item.is_educate === false).length,
          totalCabeRawit: sensusResponse.data.filter(item => item.level === 'Cabe Rawit' && item.is_educate === false).length,
          totalCabeRawitWomen: sensusResponse.data.filter(item => item.level === 'Cabe Rawit' && item.gender === 'Perempuan' && item.is_educate === false).length,
          totalCabeRawitMen: sensusResponse.data.filter(item => item.level === 'Cabe Rawit' && item.gender === 'Laki - Laki' && item.is_educate === false).length,
          totalBalita: sensusResponse.data.filter(item => item.level === 'Balita' && item.is_educate === false).length,
          totalBalitaWomen: sensusResponse.data.filter(item => item.level === 'Balita' && item.gender === 'Perempuan' && item.is_educate === false).length,
          totalBalitaMen: sensusResponse.data.filter(item => item.level === 'Balita' && item.gender === 'Laki - Laki' && item.is_educate === false).length,
          totalMen: sensusResponse.data.filter(item => item.gender === 'Laki - Laki' && item.is_educate === false).length,
          totalWomen: sensusResponse.data.filter(item => item.gender === 'Perempuan' && item.is_educate === false).length,
          totalMarriage: sensusResponse.data.filter(item => item.marriage_status === 'Menikah' && item.is_educate === false).length,
          totalWidower: sensusResponse.data.filter(item => item.marriage_status === 'Duda' && item.is_educate === false).length,
          totalWidow: sensusResponse.data.filter(item => item.marriage_status === 'Janda' && item.is_educate === false).length,
          totalDuafa: sensusResponse.data.filter(item => item.is_duafa === true && item.is_educate === false).length,
